...
`,L=[{id:"aurora",name:"Aurora Mesh",blurb:"Flowing mesh gradient — the reference look, in brand colours.",frag:y},{id:"waves",name:"Liquid Waves",blurb:"Silky sine-warped bands with a metallic sheen.",frag:b},{id:"clouds",name:"Cumulus Clouds",blurb:"Drifting fractal clouds — the literal brand metaphor.",frag:A},{id:"nebula",name:"Nebula Drift",blurb:"Deep-space dust with twinkling stars.",frag:w},{id:"plasma",name:"Plasma Warp",blurb:"Organic domain-warped plasma, slow and hypnotic.",frag:N},{id:"beams",name:"Light Beams",blurb:"Minimal scanning god-rays — the calmest option.",frag:C}],f=document.getElementById("hero-canvas");f&&Y(f);function Y(o){const e=o.getContext("webgl",{antialias:!1,alpha:!1})||o.getContext("experimental-webgl");if(!e){o.style.background="radial-gradient(120% 90% at 75% 15%, #4fc5d5 0%, #141b38 45%, #070a14 100%)";return}const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=L[0],v=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,v),e.bufferData(e.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),e.STATIC_DRAW);const d=x(e,e.VERTEX_SHADER,g),p=x(e,e.FRAGMENT_SHADER,_+a.frag),t=e.createProgram();if(e.attachShader(t,d),e.attachShader(t,p),e.linkProgram(t),!e.getProgramParameter(t,e.LINK_STATUS)){console.error("Hero shader link error:",e.getProgramInfoLog(t));return}const r={a_pos:e.getAttribLocation(t,"a_pos"),u_resolution:e.getUniformLocation(t,"u_resolution"),u_time:e.getUniformLocation(t,"u_time"),u_mouse:e.getUniformLocation(t,"u_mouse")};let s=Math.min(window.devicePixelRatio||1,2);function m(){s=Math.min(window.devicePixelRatio||1,2);const i=Math.floor(o.clientWidth*s),l=Math.floor(o.clientHeight*s);(o.width!==i||o.height!==l)&&(o.width=i,o.height=l),e.viewport(0,0,o.width,o.height)}window.addEventListener("resize",m),m();const c={x:.5,y:.5,tx:.5,ty:.5};window.addEventListener("pointermove",i=>{c.tx=i.clientX/window.innerWidth,c.ty=1-i.clientY/window.innerHeight},{passive:!0});const h=performance.now();function u(i){const l=(i-h)/1e3;c.x+=(c.tx-c.x)*.04,c.y+=(c.ty-c.y)*.04,e.useProgram(t),e.bindBuffer(e.ARRAY_BUFFER,v),e.enableVertexAttribArray(r.a_pos),e.vertexAttribPointer(r.a_pos,2,e.FLOAT,!1,0,0),e.uniform2f(r.u_resolution,o.width,o.height),e.uniform1f(r.u_time,n?10:l),e.uniform2f(r.u_mouse,c.x,c.y),e.drawArrays(e.TRIANGLE_STRIP,0,4),n||requestAnimationFrame(u)}requestAnimationFrame(u)}function x(o,e,n){const a=o.createShader(e);return o.shaderSource(a,n),o.compileShader(a),o.getShaderParameter(a,o.COMPILE_STATUS)||console.error("Shader compile error:",o.getShaderInfoLog(a)),a}
