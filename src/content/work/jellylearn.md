---
title: "Website for a global road-safety edtech leader"
client: "JellyLearn"
...
result: "A credible, modern home for a world-leading road-safety business — one that matches the scale and seriousness of the work, and gives partners and authorities every reason to trust it."
metrics:
  - value: "3.5M+"
  ...
  - value: "12+"
    label: "Years since 2012"
---

<!-- Figures and positioning from JellyLearn's own brand · TODO(owner): confirm metrics and add any results you're happy to publish. -->

JellyLearn is a world leader in evidence-based road-safety training and testing, working globally to reduce deaths on the road since 2012 — including the hazard-perception content used in the UK theory test.
